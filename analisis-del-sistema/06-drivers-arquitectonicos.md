...
|---|---|---|---|
| DA01 | El sistema debe soportar un incremento importante de usuarios, publicaciones y solicitudes de servicios. | AC03 - Escalabilidad | Puede influir en la estrategia de escalamiento y despliegue del sistema. |
| DA02 | El sistema debe mantener tiempos de respuesta adecuados durante una alta concurrencia. | AC01 - Rendimiento | Puede influir en la comunicación entre componentes, el procesamiento y el almacenamiento de información. |
